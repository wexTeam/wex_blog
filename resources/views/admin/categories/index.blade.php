...
@section('scripts')
    <script type="text/javascript">
            ...
            swal({
                ...
                function () {
                    var APP_URL = {!! json_encode(url('/')) !!}
                        ...
                        window.location.href = APP_URL + "/admin/categories/delete/2";
                });
        ...
        function del_selected() {
            swal({
                title: "Are you sure?",
                text: "These category/categoires will be deleted permanently",
                type: "warning",
                showCancelButton: true,
                closeOnConfirm: false,
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("Categories deleted successfully. Thanks");
                }, 2000);
            });
        }
    </script>
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getCategory') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
